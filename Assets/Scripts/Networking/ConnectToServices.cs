...
public class ConnectToServices : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        {
            GameObject playerListing = Instantiate(_playerListing, _playerListContent);
            playerListing.GetComponent<PlayerListItem>().SetUp(player);
        }
    ...
    public override void OnJoinRoomFailed(short returnCode, string message)
    {
         ...
         */
        _canvasManager.ShowError("Failed to join room: " + message);
    }
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        ...
        // Instantiate new room listings
        foreach (RoomInfo room in roomList)
        {
            if (room.IsOpen && room.PlayerCount < room.MaxPlayers)
            {
                GameObject roomListing = Instantiate(_roomListing, _roomListContent);
    ...
    public override void OnPlayerEnteredRoom(Player newPlayer)
    {
         ...
         */
        GameObject playerListing = Instantiate(_playerListing, _playerListContent);
        playerListing.GetComponent<PlayerListItem>().SetUp(newPlayer);
        _canvasManager.EnterRoom();
    }
